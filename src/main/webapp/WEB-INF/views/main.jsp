...
<head>
    ...
    <script type="text/javascript" src="/js/plugins/z-tree/jquery.ztree.core-3.4.js"></script>
...
<div id="main">
    <iframe name="right" id="rightMain" src="/systemmenu/list.do" frameborder="no" scrolling="auto" width="100%" height="100%" allowtransparency="true"/>
</div>
</body>
</html>
