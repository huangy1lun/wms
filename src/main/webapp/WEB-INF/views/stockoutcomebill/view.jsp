...
<form name="editForm" action="/stockoutcomebill/saveOrUpdate.do" method="post" id="editForm">
    <input type="hidden" name="id" value="${stockoutcomebill.id}" disabled/>
    <div id="container">
        <div id="nav_links">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input type="text" name="sn" value="${stockoutcomebill.sn}" class="ui_input_txt02" disabled/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">客户</td>
                    <td class="ui_text_lt">
                        <select name="client.id" class="ui_select01" disabled>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <select name="depot.id" class="ui_select01" disabled>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input name="vdate" value="${stockoutcomebill.formatVdate}" class="ui_input_txt02 Wdate" disabled
                               onClick="WdatePicker()"/>
                    </td>
                </tr>
                <tr>
                        ...
                        <table class="edit_table" cellspacing="0" cellpadding="0" border="0" style="width: auto">
                            ...
                            <c:forEach items="${stockoutcomebill.items}" var="item">
                                <tr>
                                    ...
                                    <td><input tag="salePrice" name="" value="${item.salePrice}" disabled
