...
<form name="editForm" action="/stockincomebill/saveOrUpdate.do" method="post" id="editForm">
    <input type="hidden" name="id" value="${stockincomebill.id}" disabled/>
    <div id="container">
        <div id="nav_links">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input type="text" name="sn" value="${stockincomebill.sn}" class="ui_input_txt02" disabled/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input name="vdate" value="${stockincomebill.formatVdate}" class="ui_input_txt02 Wdate" disabled
                               onClick="WdatePicker()"/>
                    </td>
                </tr>
                <tr>
