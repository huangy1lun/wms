        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input type="text" name="sn" value="${orderbill.sn}" class="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <%--<fmt:formatDate value="${orderbill.vdate}" pattern="yyyy-MM-dd" var="formatDate"/>--%>
                        <input name="vdate" value="${orderbill.formatVdate}" class="ui_input_txt02 Wdate"  onClick="WdatePicker()"/>
                    </td>
                </tr>
                <tr>
