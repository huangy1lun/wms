    ...
    <script>
        $(function () {
            ...
            $("#edit_table_body").on("click", ".searchproduct", function () {
                ...
                $.dialog.open("/product/allProduct.do", {
                    title: "选择商品",
                    width: 1000,
                    height: 680,
                    close: function () {
            ...
            $("#edit_table_body").on("change", "[tag=costPrice],[tag=number]", function () {
                var tr = $(this).closest("tr");
                var price  = parseFloat(tr.find("input[tag=costPrice]").val() || 0);
                var number  = parseFloat(tr.find("input[tag=number]").val() || 0);
                tr.find("[tag=amount]").text((price*number).toFixed(2));
            });
            ...
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        <input name="vdate" value="${stockincomebill.formatVdate}" class="ui_input_txt02 Wdate"
                               onClick="WdatePicker()"/>
                    </td>
                </tr>
                <tr>
