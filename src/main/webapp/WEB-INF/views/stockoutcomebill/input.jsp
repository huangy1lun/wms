    ...
    <script>
        $(function () {
            ...
            $("#edit_table_body").on("change", "[tag=salePrice],[tag=number]", function () {
                var tr = $(this).closest("tr");
                var price = parseFloat(tr.find("[tag=salePrice]").val() || 0);
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input type="text" name="sn" value="${stockoutcomebill.sn}" class="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <%--<fmt:formatDate value="${stockoutcomebill.vdate}" pattern="yyyy-MM-dd" var="formatDate"/>--%>
                        <input name="vdate" value="${stockoutcomebill.formatVdate}" class="ui_input_txt02 Wdate"  onClick="WdatePicker()"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <table class="edit_table" cellspacing="0" cellpadding="0" border="0" style="width: auto">
                            ...
                            <c:choose>
                                <c:when test="${stockoutcomebill == null}">
                                    <tr>
                                        <td></td>
                                        <td>
                                ...
                                <c:otherwise>
                                    <c:forEach items="${stockoutcomebill.items}" var="item">
                                        <tr>
                                            ...
                                            <td><input tag="salePrice" name="" value="${item.salePrice}"
                                                       class="ui_input_txt00"/></td>
